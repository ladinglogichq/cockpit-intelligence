...
const TOOL_DEFS: Anthropic.Tool[] = [
  ...
  { name: "ocr_extract", description: ocrExtract.description, input_schema: { type: "object" as const, properties: { url: { type: "string" }, documentId: { type: "string" }, pages: { type: "string" } }, required: [] } },
